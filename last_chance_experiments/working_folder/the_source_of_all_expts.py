...
#TO DO
Fig 3 (real events, why the landscape looks like it dows, daily storms, effets on all sediment)
    ...
    4) how often is sediment mobilized in upstream sections

    
Fig 4  (intensity/ floodwave/ large sediment movement / climate change / effects on boulders)
    5) Find the upper limit of sediment size of which sediment wont move in the steep section / intermediate section
        
    6) what if i investigate the flood wave, and how rainfall intensity can modulate top down processes 
    in this way climate change can obliterate the signal from boulders
"""

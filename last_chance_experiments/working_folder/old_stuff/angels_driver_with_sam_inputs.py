...
gsd = np.loadtxt('LC3_large_grain_size_dist1.txt')                             # Check inside the txt file for more information on the file format
bed_surf__gsd_loc_node = 'lc3_gsd_locations.asc'

# Time variables
t = 0
max_dt = 0.01                         # Overland flow will use the min time step between this value and the automatically calculated. Use seconds.

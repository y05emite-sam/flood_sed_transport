...
# Fixed nodes and nodes for plotting
# Need to find nodes and links along channel to record information for plotting
...
while t < sim_max_t:
    ...
    if of.dt is None:
        ...
        print(f"Warning: Invalid of.dt detected (of.dt: {of.dt}) at time t: {t}")
...
Here is under construction
    ...
    will any of the big things move in steep area
    how much sediment motion there is?
